...
SERVER_NAME = env.get('SERVER_NAME', 'eboardevals.csh.rit.edu')
...
OIDC_CLIENT_CONFIG = {
    'client_id': env.get('OIDC_CLIENT_ID', 'eboardevals'),
    'client_secret': env.get('OIDC_CLIENT_SECRET', ''),
    'post_logout_redirect_uris': [env.get('OIDC_LOGOUT_REDIRECT_URI', 'https://eboardevals.csh.rit.edu/logout')]
}

LDAP_BIND_DN = env.get("LDAP_BIND_DN", default="cn=eboardevals,ou=Apps,dc=csh,dc=rit,dc=edu")
